...
public class FrozenSolidLayer<T extends LivingEntity, M extends EntityModel<T>> extends RenderLayer<T, M> {

    private static final ResourceLocation FROZEN_OVERLAY = new ResourceLocation(Elixirs.MODID, "textures/entity/frozen_solid.png");
